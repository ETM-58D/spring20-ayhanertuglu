...
library(quantmod)
library(reshape2)
data=fread("/Users/ayhanertuglu/Desktop/Okul/II.Dönem/Business Analytics/Homework 4/ETM58D_Spring20 HW 4_electricity_load_Turkey.csv")
...
data_2=fread("/Users/ayhanertuglu/Desktop/Okul/II.Dönem/Business Analytics/Homework 4/ETM58D_Spring20 HW 4_electricity_load_Turkey.csv")

#codes for question 3
full_data=fread("/Users/ayhanertuglu/Desktop/Okul/II.Dönem/Business Analytics/Homework 4/ETM58D_Spring20 HW 4_electricity_load_Turkey.csv")
full_data_1=fread("/Users/ayhanertuglu/Desktop/Okul/II.Dönem/Business Analytics/Homework 4/ETM58D_Spring20 HW 4_electricity_load_Turkey.csv")
...
server <- function(input, output, session) {
  ...
  output$my_plot_2 <-  renderPlot({ggplot(plot_long(), aes(Hour, value, colour=variable)) +
      ...
      scale_x_continuous(breaks=seq(0, 24, by = 1)) + 
      labs(title= "Hourly Average Temperature(°C) Values by Cities",
           x= "Hour",
  ...
  output$my_plot_3 <-  renderPlot({ggplot(Forecast_data(), aes(Hour, Forecast)) +
      ...
      theme(axis.title.y = element_text(margin = margin(t = 0, r = 10, b = 0, l = 0), size = 15), 
            ...
            text = element_text(size = 15)) +
      scale_x_continuous(breaks=seq(0, 24, by = 1)) + 
      labs(title= "Hourly Forecasted Consumption",
           x= "Hour",
           y= "Forecasted Consumption")
  })
}
