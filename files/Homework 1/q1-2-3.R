...
#b)In this part, we calculated hypersphere and hypercube in dimension=3 and dimension=In dimension 2, we used (nof_sphere/nof_samples)*4 and in dimension=3, we used nof_sphere/nof_samples*6 as we found from the calculations
...
ratings=fread("/Users/ayhanertuglu/Desktop/Okul/II.Dönem/Business Analytics/Homework1/Q3/ETM58D_Spring20_HW1_q3_data/ETM58D_Spring20_HW1_q3_Netflix_data.txt")
